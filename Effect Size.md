...
unnamed-asteroid control. Adding Rahu strengthens the omnibus signal: the
mean north lunar node contributes a standardised effect of 3.1 SDs (compound
null) or 2.3 SDs (unnamed-MBA null), comparable to the slow-moving outer
planets.**
...
chance level. FPOA, Pluto and Neptune are the strongest at ≈0.21–0.22;
...
deviations above chance: FPOA 4.87, Pluto 4.41, Neptune 4.16, Rahu 3.13,
...
FPOA, Pluto, Neptune, Saturn, Uranus, Rahu, Jupiter, the Sun and
...
> FPOA, and the mean north lunar node Rahu (d = 3.13 compound, 2.28
